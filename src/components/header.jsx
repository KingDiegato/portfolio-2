...
export default function Header() {
  return (
    <header className='flex place-items-baseline place-content-evenly py-2 px-16 border-b border-fuchsia-500 w-screen'>
      <div>
      ...
      <nav className='flex gap-6 evenly text-[calc(0.75rem+0.4vw)]'>
